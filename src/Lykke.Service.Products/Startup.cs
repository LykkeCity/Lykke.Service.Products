...
using Lykke.Service.Products.Settings;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                {
                    options.DefaultLykkeConfiguration("v1", "Products API");
                });
                ...
                builder.RegisterModule(new AzureRepositories.AutofacModule(
                    appSettings.Nested(o => o.ProductsService.Db.DataConnectionString), Log));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime appLifetime)
        {
            try
            {
                ...
                app.UseLykkeMiddleware("Products", ex => new { Message = "Technical problem" });
        ...
        private static ILog CreateLogWithSlack(IServiceCollection services, IReloadingManager<AppSettings> settings)
        {
            ...
            var dbLogConnectionStringManager = settings.Nested(x => x.ProductsService.Db.LogsConnectionString);
            ...
            var persistenceManager = new LykkeLogToAzureStoragePersistenceManager(
                AzureTableStorage<LogEntity>.Create(dbLogConnectionStringManager, "ProductsLog", consoleLogger),
                consoleLogger);
